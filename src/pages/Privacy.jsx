      ...
      <div class="container">
        <div class="content-box">
          <div class="content-privacy">
            <div class="content-privacy__left">
              <h2 class="content-privacy__title">
                Политика в отношении обработки персональных данных
              </h2>

              <h3 class="content-privacy__subtitle">1. Общие положения</h3>
              <p class="content-privacy__text">
                ...
                персональных данных, предпринимаемые kuzpugonka (далее –
                Оператор).
              </p>
              <p class="content-privacy__text">
              ...
              <p class="content-privacy__text">
                ...
                веб-сайта https://abito.
              </p>
              <h3 class="content-privacy__subtitle">
              ...
              <p class="content-privacy__text">
                2.9. Пользователь – любой посетитель веб-сайта https://abito;
              </p>
              <p class="content-privacy__text">
              ...
              <p class="content-privacy__text">3.1. Фамилия, имя, отчество;</p>
              <p class="content-privacy__text">3.2. Электронный адрес;</p>
              <p class="content-privacy__text">3.3. Номера телефонов;</p>
              <p class="content-privacy__text">
                3.4. Год, месяц, дата и место рождения;
              </p>
              <p class="content-privacy__text">3.5. Фотографии;</p>
              <p class="content-privacy__text">
                3.6. Также на сайте происходит сбор и обработка обезличенных
                данных о посетителях (в т.ч. файлов «cookie») с помощью сервисов
                интернет-статистики (Яндекс Метрика и Гугл Аналитика и других).
              </p>
              <p class="content-privacy__text">
                3.7. Вышеперечисленные данные далее по тексту Политики
              ...
              <p class="content-privacy__text">
                ...
                Оператору письмо на адрес электронной почты privacy@abito с
              ...
              <p class="content-privacy__text">
                ...
                https://abito. Заполняя соответствующие формы и/или отправляя
              ...
              <p class="content-privacy__text">
                ...
                Оператора privacy@abito с пометкой «Актуализация персональных
                данных».
              </p>
              <p class="content-privacy__text">
                ...
                privacy@abito с пометкой «Отзыв согласия на обработку
                персональных данных».
              </p>
              <h3 class="content-privacy__subtitle">
              ...
              <p class="content-privacy__text">
                ...
                в сети Интернет по адресу https://abito/privacy.
              </p>
            </div>
          </div>
